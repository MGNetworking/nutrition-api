namespace NutritionApi.Integration.Tests.Jobs;
...
public sealed class JobStatusTest(IntegrationFactory factory)
{
    ...
    /// </remarks>
    [Fact]
    public async Task IT_JOB_01_Aucun_job_enregistre_renvoie_une_liste_vide()
    {
    ...
    /// </remarks>
    [Fact]
    public async Task IT_JOB_02_Job_jamais_execute_est_scheduled()
    {
        await ReregisterJobsAsync();
    ...
    /// </remarks>
    [Fact]
    public async Task IT_JOB_03_Job_execute_avec_succes_est_succeeded()
    {
        await ReregisterJobsAsync();
    ...
    /// </remarks>
    [Fact]
    public async Task IT_JOB_04_Le_job_d_import_porte_le_nom_import_off()
    {
        await ReregisterJobsAsync();
